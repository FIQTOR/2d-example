...
const MusicSectionOld = ({ handleCloseSection }) => {
  ...
  return (
    <>
      <SwiperSlide key={index} className={`h-full w-fit justify-center items-center overflow-visible`} style={{
        ...
        <div className={`${musicIndex === index ? 'scale-150 md:scale-[2.5]' : `scale-100 md:scale-[2]`} w-[60%] bg-black bg-opacity-30 p-[5%] md:p-2 max-w-96 md:max-w-32 md:rounded-lg  rounded-3xl duration-1000 z-40`}>
...
export default MusicSectionOld