      ...
      <div className='absolute w-full min-h-screen bg-black bg-opacity-70 z-30 flex justify-center items-center backdrop-blur-sm'>
        ...
        <button
          ...
          className={`${isRendered ? "scale-[3]" : "-translate-x-60"
            } absolute flex justify-center items-center w-40 h-40 active:opacity-90 duration-1000`}
        >
          <img src="img/gift.png" className="w-14 z-20 translate-x-1" />
        </button>
          <div  className={` ${showVideo ? '' : 'hidden'} w-[90%] z-20`}>
  ...
  return (
    ...
    <div className='absolute w-full min-h-screen bg-black bg-opacity-70 z-30 flex justify-center items-center backdrop-blur-sm'>
      ...
      <div className='absolute z-20'>
        ...
        <span className='absolute top-10 left-7 text-xs pr-7 font-bold'>{displayText}</span>
      </div>
      ...
      {mailIndex === (mails.length - 1) &&
        ...
        '>
          ...
          <button onClick={() => handleAnniversaryDate('3 JULI 2020')} className='w-32 py-2 border-2 border-[rgba(112,44,43)] bg-[rgb(243,215,212)] rounded-2xl active:opacity-70
        '>
            3 JULI 2020
          </button>
          <button onClick={() => handleAnniversaryDate('1 MARET 2023')} className='w-32 py-2 border-2 border-[rgba(112,44,43)] bg-[rgb(243,215,212)] rounded-2xl active:opacity-70'>
            1 MARET 2023
          </button>
        </div>
      }
